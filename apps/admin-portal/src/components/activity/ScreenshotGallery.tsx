        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
            {screenshots.map((ss) => (
                ...
                >
                    ...
                    <div className="relative aspect-video rounded-[24px] overflow-hidden bg-main border border-border shadow-sm group-hover:border-primary/40 group-hover:shadow-elevated transition-all duration-500 cursor-zoom-in ring-4 ring-transparent group-hover:ring-primary/5">
                        <SecureImage 
                            path={ss.file_url} 
                        ...
                        {/* Status HUD */}
                        <div className="absolute left-4 top-4 px-3 py-1.5 bg-black/40 backdrop-blur-md border border-white/10 rounded-lg text-[9px] font-bold text-white uppercase tracking-widest opacity-0 group-hover:opacity-100 translate-y-[-10px] group-hover:translate-y-0 transition-all duration-500">
                            Verified Source
                        </div>
                    </div>
                    ...
                    <div className="mt-5 flex items-center justify-between px-2">
                        <div className="flex flex-col gap-1.5">
                            ...
                            <span className="text-[10px] font-bold text-text-muted uppercase tracking-widest ml-3.5 opacity-70">
                        ...
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-surface-hover border border-border rounded-xl group-hover:bg-primary/5 group-hover:border-primary/10 transition-colors">
                            ...
                            <span className="text-[9px] font-bold text-text-muted uppercase tracking-[0.1em] group-hover:text-primary/70">Secure</span>
                        </div>
                    </div>
                </div>
            ))}
