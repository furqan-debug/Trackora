    ...
    if (step === 'loading') {
        ...
        <div className="min-h-screen bg-background relative overflow-hidden flex items-center justify-center p-8">
            ...
            <div className="flex flex-col items-center gap-6 text-text-primary animate-in fade-in duration-700">
                ...
                <p className="text-[11px] font-bold tracking-[0.3em] opacity-40 font-mono">Verifying recovery link...</p>
            </div>
        </div>
        );
    }
    ...
    if (step === 'error') {
        ...
        <div className="min-h-screen bg-background relative overflow-hidden flex items-center justify-center p-8">
            ...
            <div className="relative z-10 w-full max-w-[480px] text-center">
                <Card className="p-12 shadow-glow bg-surface/60 backdrop-blur-3xl border-black/[0.02] rounded-[56px] space-y-10 animate-in stagger-1">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-[11px] font-bold text-text-secondary tracking-[0.2em] font-mono leading-relaxed opacity-50">{errorMsg}</p>
                    </div>
                    <button
                        className="w-full py-5 rounded-[24px] bg-primary text-white text-[12px] font-bold tracking-[0.3em] shadow-glow-primary hover:scale-[1.02] active:scale-95 transition-all"
            ...
            <div className="relative z-10 w-full max-w-[480px] text-center">
                <Card className="p-12 shadow-glow bg-surface/60 backdrop-blur-3xl border-black/[0.02] rounded-[56px] space-y-10 animate-in stagger-1">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-[11px] font-bold text-text-secondary tracking-[0.2em] font-mono leading-relaxed opacity-50">
        ...
        <div className="min-h-screen bg-background relative overflow-hidden flex items-center justify-center p-8">
            ...
            <div className="relative z-10 w-full max-w-[480px]">
                <div className="mb-12 text-center">
                    <div className="inline-flex items-center gap-4 px-6 py-2.5 rounded-[24px] bg-surface border border-black/[0.05] shadow-glow mb-10 group">
                        <ShieldCheck className="w-5 h-5 text-primary group-hover:scale-110 transition-transform" strokeWidth={2} />
                        <span className="text-[11px] font-bold tracking-[0.3em] text-text-primary font-mono">Security Settings</span>
                    </div>
                    ...
                    <p className="text-[11px] font-bold text-text-secondary tracking-[0.3em] font-mono leading-relaxed opacity-50">
                        Choose a strong password for your account
                    </p>
                </div>

                <Card className="p-12 shadow-glow bg-surface/60 backdrop-blur-3xl border-black/[0.02] rounded-[56px] animate-in stagger-1">
                    <form onSubmit={handleSubmit} className="space-y-10">
                        ...
                        {formError && (
                            <div className="p-5 rounded-[24px] bg-rose-500/[0.03] border border-rose-500/10 text-rose-500 text-xs font-bold font-mono">
                                {formError}
                            </div>
                        )}
                        ...
                        <Button
                            ...
                            className="w-full py-5 rounded-[24px] text-[12px] font-bold tracking-[0.3em] shadow-glow-primary hover:scale-[1.02] active:scale-95 transition-all"
