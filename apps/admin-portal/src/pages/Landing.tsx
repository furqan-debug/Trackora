...
function DownloadTabs() {
    ...
    const platforms = {
        windows: {
            ...
            primaryLink: 'https://github.com/furqan-debug/Trackora/releases/download/v1.0.6/Trackora_1.0.6_x64-setup.exe',
            secondary: 'Download .msi (Enterprise)',
            secondaryLink: 'https://github.com/furqan-debug/Trackora/releases/download/v1.0.6/Trackora_1.0.6_x64_en-US.msi'
        },
        macos: {
