...
try {
  ...
  const latest = {
    version: VERSION,
    notes: `TrackOwl v${VERSION} - Atomic session management. Fixed race conditions during tracking start by using server-side RPC functions. Required migration: fix_session_conflicts.sql`,
