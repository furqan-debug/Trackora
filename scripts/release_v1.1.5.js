...
function sign(filePath) {
  ...
  // Using npx tauri signer sign. In Tauri v2, the CLI might be different, 
  // but let's try the existing command first as it worked for 1.1.4.
...
try {
  ...
  const latest = {
    version: VERSION,
    notes: `TrackOwl v${VERSION} - Manual Release for testing.`,
