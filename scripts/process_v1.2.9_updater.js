...
(async () => {
  try {
    ...
    const latest = {
      version: VERSION,
      notes: `TrackOwl v${VERSION} — Stability & Marketing Update.\n\n- ✅ Fixes macOS login screen crash by delaying input listener & checking accessibility permissions.\n- ✅ Adds a new landing page component and marketing section.\n- ✅ Extends Apple Silicon support branding to include M4 and M5 chips.\n- ✅ Removes legacy Linux panels for a streamlined presentation.`,
