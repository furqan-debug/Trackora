...
try {
  ...
  const latest = {
    version: VERSION,
    notes: `TrackOwl v${VERSION} — Timezone-aware activity tracking, accurate daily totals, session deduplication, and stability improvements.`,
  ...
  // 7. Done
  console.log('\n\x1b[32m════════════════════════════════════════════════');
  console.log(`  ✅  TrackOwl v${VERSION} release packaged!`);
  console.log('════════════════════════════════════════════════\x1b[0m');
